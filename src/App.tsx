...
const App: React.FC = () => {
  ...
  // Plan route when both start and end locations are set
  useEffect(() => {
    ...
    async function fetchRoute() {
      const url = `https://api.mapbox.com/directions/v5/mapbox/driving/${startLocation.longitude},${startLocation.latitude};${endLocation.longitude},${endLocation.latitude}?geometries=geojson&access_token=${MAPBOX_TOKEN}`;
